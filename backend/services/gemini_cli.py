...
def generate_insights(diff_data, prompt_path=None):
    ...
    try:
        ...
        if prompt_path and os.path.exists(prompt_path):
            ...
            prompt_text = "Analyze these Excel diff changes and provide high-level insights, trends, and anomalies."
            
        cmd = f"cat {temp_file} | gemini -p '{prompt_text}'"
